...
public class Aplicacion extends Application {
	...
	public void start(Stage escenarioPrincipal) {
		...
		escenarioPrincipal.getIcons().add(new Image("file:img/logo.png"));
	...
	private void crearGrilla() {
		...
		grilla.setHgap(20);
		grilla.setVgap(20);
		grilla.setStyle("-fx-background-color:#5b82b3");
		
		Label rojo = new Label("Nombre del jugador Rojo");
		Label amarillo = new Label("Nombre del jugador Amarillo");
		Label filas = new Label("Filas");
		Label columnas = new Label("Columnas");
		
		Text textoTitulo = new Text(TITULO);
		textoTitulo.setFont(new Font("Arial Black", 40));
		textoTitulo.setFill(Color.ALICEBLUE);
		...
		rojo.setFont(Font.font("Arial Black", 15));
		rojo.setTextFill(Color.ALICEBLUE);
		amarillo.setFont(Font.font("Arial Black", 14));
		amarillo.setTextFill(Color.ALICEBLUE);
		filas.setFont(Font.font("Arial Black", 16));
		filas.setTextFill(Color.ALICEBLUE);
		columnas.setFont(Font.font("Arial Black", 16));
		columnas.setTextFill(Color.ALICEBLUE);
